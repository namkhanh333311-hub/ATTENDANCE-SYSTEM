...
class Classroom:
    ...
    # --- CHỨC NĂNG 2: Lưu thông tin lớp học ---

    def to_file_string(self) -> str:
        """
        Định dạng:
        class_id|class_name|schedule|sv01,sv02,sv03
        """
    ...
    def from_file_string(cls, line: str):
        """
        Đọc dữ liệu từ file và tạo lại đối tượng Classroom
        """
        ...
        raise ValueError(
            f"Dòng dữ liệu không hợp lệ: {line}"
        )
